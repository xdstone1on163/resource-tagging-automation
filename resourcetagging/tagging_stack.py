...
class ResourceTaggingStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        lambda_role.add_to_policy(_iam.PolicyStatement(
            ...
            "rds:AddTagsToResource", "rds:DescribeDBClusterSnapshots", "rds:DescribeDBClusters",
            "docdb:AddTagsToResource", "docdb:DescribeDBInstances", "docdb:DescribeDBClusters", "docdb:ListTagsForResource",
            ...
            "logs:PutLogEvents", "logs:TagLogGroup", "logs:ListTagsLogGroup", "tag:getResources", "tag:getTagKeys", "tag:getTagValues", "tag:TagResources", "tag:UntagResources", "cloudformation:DescribeStacks", 
            ...
            "cloudwatch:TagResource", "mq:CreateTags", 
